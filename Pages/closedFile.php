...
//echo $selectedCrime->LinkedId;
$idr = $selectedCrime->LinkedId;

$Mycrime = GetByCrimeID($idr);
//
//echo "fbi code: " .$Mycrime->fbiCodeId . "----!";
$btnService ="hidden";
...
if( $newUser->RoleID == 1)
{
echo   "<a href='AdminHome.php' > Home</a> > Edit request ";
}
else
{
echo   "<a href='UserHome.php' > Home</a> > Edit request ";}
...
?>
  ...
  <hr/>
	...
	<div class="col-md-1" >  log out </div>
            ...
            <div class="form-group">
             <label for="date">Crime Date time</label>
                <div class='input-group date' id='datetimepicker1'>
                    ...
                    <input type='text' name="CrimeDate" value="<?php echo $selectedCrime->CrimeDate  ?>" class="form-control" placeholder="Date time" disabled/>
...
<select class="form-control" name="PrimaryType" id="PrimaryType" disabled>
<?php 
...
?>
		  ...
		  <div class='col-sm-6'>
		 	<div class="form-group">
				...
				<select class="form-control" name="Desc" id="Desc" disabled>
<?php 
...
disabled>
		 ...
		 <div class='col-sm-6'>
				...
				<input type="text" class="form-control" name="BlockDetails" id="txtautocomplete" placeholder="Write complete Address" value="<?php echo $selectedCrime->BlockDetail  ?>" disabled>
				</div>
		 </div>
</div>
...
<div class="row">
 ...
 <div class="form-group">
<b> Beat</b> 
 <select class="form-control" name="Beat" id="Desc" disabled>
<?php 
foreach($Beat as $item) {

$selectedBeat ="";
    if($Mycrime->BeatId == $item->Id)
    {
        $selectedBeat = "selected='selected'";
    }

    echo "<option  ".$selectedBeat."  value=".$item->Id .">" . $item->Desc . "</option>";
}
...
?>
     ...
     <div class='col-sm-6'>
         <div class="form-group">
<b> Disctrict</b> 
 <select class="form-control" name="Disctrict" id="Desc" disabled>
<?php 
foreach($Disctrict as $item) {
$selectedType ="";
    if($Mycrime->DistrictId == $item->Id)
    {
        $selectedType = "selected='selected'";
    }
    echo "<option ".$selectedType."  value=".$item->Id .">" . $item->Desc . "</option>";
}
...
<b> Community</b> 
 <select class="form-control" name="Community" id="Desc" disabled>
<?php 
foreach($Community as $item) {
$selectedType ="";
    if($Mycrime->CommunityId == $item->Id)
    {
        $selectedType = "selected='selected'";
    }
...
?>
     ...
     <div class='col-sm-6'>
         <div class="form-group">
<b> FBI Codes</b> 
 <select class="form-control" name="fbicode" id="Desc" disabled>
<?php 
foreach($FbiCodes as $item) {
$selectedFbi ="";
    if($Mycrime->fbiCodeId == $item->Id)
    {
        $selectedFbi = "selected='selected'";
    }
    echo "<option ".$selectedFbi."   value=".$item->Id .">" . $item->Desc . "</option>";
}
...
<div class="row">
 ...
 <div class='col-sm-6'><div class="form-group">
 <b> Ward</b> 
 <select class="form-control" name="ward" id="Desc" disabled>
<?php 
foreach($ward as $item) {

$selectedType ="";
    if($Mycrime->wardID == $item->Id)
    {
        $selectedType = "selected='selected'";
    }
    echo "<option ".$selectedType."   value=".$item->Id .">" . $item->Desc . "</option>";
...
$domesticDone ="";
    if($Mycrime->domestic == "true")
    {
        $domesticDone = "checked='checked'";  
    }
    else
    {
        $domesticDone ="";
...
?>
 ...
 <input type="checkbox" <?php echo $domesticDone ?> class="checkbox" name="Domestic" value="true" disabled>
 </div></div>
...
$ArrestDone ="";
    if($Mycrime->Arrest == "true")
    {
        $ArrestDone = "checked='checked'"; 
    }else
    {
        $ArrestDone = ""; 
    }
...
?>
 ...
 <input type="checkbox" <?php echo $ArrestDone ?>  class="checkbox" name="Arrest" value="true" disabled>
 </div></div>
</div>
...
<input type="<?php echo $btnService?>" class="btn btn-success" name="submit" value="Pick up for Service">
